...
class RWMB_Media_Field extends RWMB_File_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		self::localize_script( 'rwmb-media', 'i18nRwmbMedia', array(
			'add'                => apply_filters( 'rwmb_media_add_string', _x( '+ Add Media', 'media', 'tmrco-core-main' ) ),
			'single'             => apply_filters( 'rwmb_media_single_files_string', _x( ' file', 'media', 'tmrco-core-main' ) ),
			'multiple'           => apply_filters( 'rwmb_media_multiple_files_string', _x( ' files', 'media', 'tmrco-core-main' ) ),
			'remove'             => apply_filters( 'rwmb_media_remove_string', _x( 'Remove', 'media', 'tmrco-core-main' ) ),
			'edit'               => apply_filters( 'rwmb_media_edit_string', _x( 'Edit', 'media', 'tmrco-core-main' ) ),
			'view'               => apply_filters( 'rwmb_media_view_string', _x( 'View', 'media', 'tmrco-core-main' ) ),
			'noTitle'            => _x( 'No Title', 'media', 'tmrco-core-main' ),
			'loadingUrl'         => RWMB_URL . 'img/loader.gif',
			'extensions'         => self::get_mime_extensions(),
			'select'             => apply_filters( 'rwmb_media_select_string', _x( 'Select Files', 'media', 'tmrco-core-main' ) ),
			'or'                 => apply_filters( 'rwmb_media_or_string', _x( 'or', 'media', 'tmrco-core-main' ) ),
			'uploadInstructions' => apply_filters( 'rwmb_media_upload_instructions_string', _x( 'Drop files here to upload', 'media', 'tmrco-core-main' ) ),
		) );
	}
