...
class RWMB_Core {
	...
	public function plugin_links( $links ) {
		$links[] = '<a href="https://metabox.io/docs/">' . esc_html__( 'Documentation', 'tmrco-core-main' ) . '</a>';
		$links[] = '<a href="https://metabox.io/plugins/">' . esc_html__( 'Extensions', 'tmrco-core-main' ) . '</a>';
		return $links;
	}
