...
class tmrco_Core_social_share_Widget extends WP_Widget{
	...
	public function __construct() {
		parent::__construct( 'tmrco_Core_social_share_Widget', esc_html__("tmrco Social Link Widgets",'tmrco-core'), array('description' => esc_html__("This Social Link Widgets",'tmrco-core')) );
	}
...
*-------------------------------------------------------*/
	...
	public function form( $instance )
	{
	   ...
	   ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e('Title :', 'tmrco-core'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'facebook_url' ); ?>"><?php esc_html_e('Facebook URL: ', 'tmrco-core'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'twitter_url' ); ?>"><?php esc_html_e('Twitter URL: ', 'tmrco-core'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'linkedin_url' ); ?>"><?php esc_html_e('Linkedin URL: ', 'tmrco-core'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'rss_url' ); ?>"><?php esc_html_e('RSS URL: ', 'tmrco-core'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'pinterest_url' ); ?>"><?php esc_html_e('Pinterest URL: ', 'tmrco-core'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'youtube_url' ); ?>"><?php esc_html_e('Youtube URL: ', 'tmrco-core'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'instagram_url' ); ?>"><?php esc_html_e('Instagram URL: ', 'tmrco-core'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'vimeo_url' ); ?>"><?php esc_html_e('Vimeo URL: ', 'tmrco-core'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'dribble_url' ); ?>"><?php esc_html_e('Dribble URL: ', 'tmrco-core'); ?></label>
