...
if (! class_exists('tmrco_Core_Countdown')) {

    class tmrco_Core_Countdown{
                    ...
                    array(
                        'attributes' => array(
                            ...
                            'digiteColor' => array(
                                ...
                                'default' => '#1f2949',
                                'style' => [(object) [
                                    'selector' => '{{QUBELY}} .tmrco-home-countdown-content .tmrco-home-countdown-item .number h4 {color: {{digiteColor}};}'
                                ]]
                            ), 
                            'digiteTypography'   => array(
                                ...
                                'style'         => [(object) [
                                    'selector'  => '{{QUBELY}} .tmrco-home-countdown-content .tmrco-home-countdown-item .number h4'
                                ]]
                            ),
                            ...
                            'digiteTextColor' => array(
                                ...
                                'default' => '#b0b4b8',
                                'style' => [(object) [
                                    'selector' => '{{QUBELY}} .tmrco-home-countdown-content .tmrco-home-countdown-item .text h5 {color: {{digiteTextColor}};}'
                                ]]
                            ), 
                            'digiteTextTypography'   => array(
                                ...
                                'style'         => [(object) [
                                    'selector'  => '{{QUBELY}} .tmrco-home-countdown-content .tmrco-home-countdown-item .text h5'
                                ]]
                            ),
                            ...
                            'titleColor' => array(
                                ...
                                'default' => '#1f2949',
                                'style' => [(object) [
                                    'selector' => '{{QUBELY}} .tmrco-home-countdown-title .tmrco-countdown-title {color: {{titleColor}};}'
                                ]]
                            ), 
                            'titleTypography'   => array(
                                ...
                                'style'         => [(object) [
                                    'selector'  => '{{QUBELY}} .tmrco-home-countdown-title .tmrco-countdown-title'
                                ]]
                            ),
                            'titleSpacing'      => array(
                                'type'          => 'object',
                                ...
                                'style'         => [
                                    (object) [
                                        'selector' => '{{QUBELY}} .tmrco-home-countdown-title h3 {margin-bottom: {{titleSpacing}};}'
                                    ]
                                ]
                            ),
                            ...
                            'subtitleSpacing'      => array(
                                ...
                                'style'         => [
                                    (object) [
                                        'selector' => '{{QUBELY}} .tmrco-home-countdown-content .tmrco-home-countdown-header {margin-bottom: {{subtitleSpacing}};}'
                                    ]
                                ]
                            ),
                            ...
                            'buttonColor' => array(
                                ...
                                'default' => '#ffffff',
                                'style' => [(object) [
                                    'selector' => '{{QUBELY}} .tmrco-home-countdown-content .tmrco-home-countdown-cta-btn a.btn-primary {color: {{buttonColor}};}'
                                ]]
                            ), 
                            'buttonBgColor' => array(
                                'type' => 'object',
                                ...
                                'style' => [(object) [
                                    'selector' => '{{QUBELY}} .tmrco-home-countdown-content .tmrco-home-countdown-cta-btn .btn-primary'
                                ]]
                            ),
                            ...
                            'buttonHoverColor' => array(
                                ...
                                'default' => '#ffffff',
                                'style' => [(object) [
                                    'selector' => '{{QUBELY}} .tmrco-home-countdown-content .tmrco-home-countdown-cta-btn a.btn-primary:hover {color: {{buttonHoverColor}};}'
                                ]]
                            ),
                            ...
                            'countdownBgColor' => array(
                                ...
                                'style' => [(object) [
                                    'selector' => '{{QUBELY}} .tmrco-home-countdown-content'
                                ]]
                            ),
                            'bgPadding'      => array(
                                'type'          => 'object',
                                ...
                                'style'         => [
                                    (object) [
                                        'selector' => '{{QUBELY}} .tmrco-home-countdown-content {padding: {{bgPadding}}; display: block;}'
                                    ]
                                ]
                            ),
                            'border'            => array(
                        ...
                        'render_callback' => array( $this, 'tmrco_core_countdown_block_callback' ),
                )
            );
        }
    
		public function tmrco_core_countdown_block_callback( $att ){
            ...
            $html = '';
            $html .= '<div class="tmrco-home-countdown qubely-block-'.$uniqueId.'">';
                $html .= '<div class="tmrco-home-countdown-content '.$interaction.'" '.$animation.'>';
                    $html .= '<header class="tmrco-home-countdown-header">';
                        if( $countdownTitle ) {
                            $html .= '<div class="tmrco-home-countdown-title">';
                                $html .= '<h3 class="tmrco-countdown-title">'. $countdownTitle .'</h3>';
                            $html .= '</div>';
                        }
                        if( $countdownIntro ) {
                            $html .= '<div class="tmrco-home-countdown-body">';
                                $html .= '<p class="countdown-intro-text">'. $countdownIntro .'</p>';
                            $html .= '</div>';
                        }
                    $html .= '</header>';

                    $html .= '<footer class="tmrco-home-countdown-footer">';
                        $html .= '<div class="row">';
                                
                                $html .= ($enableButton) ? '<div class="col-md-7 col-sm-12">' : '<div class="col-md-12 col-sm-12">';
                                    $html .= '<div class="tmrco-home-countdown-wrapper" data-enddate='.$endDate.'>';
                                        $html .= '<div class="tmrco-home-countdown-item">';
                                ...
                                if($enableButton) {
                                    $html .= '<div class="col-md-5 col-sm-12">';
                                        $html .= '<div class="tmrco-home-countdown-cta-btn">';
