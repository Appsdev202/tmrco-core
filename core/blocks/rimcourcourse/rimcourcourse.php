                                    ...
                                    if( $enableMeta == 1) {  
                                        $html .= '<div class="course-info">';
                                            $html .= '<ul class="category-list">';
                                                $html .= '<li><span>'.__('By ', 'tmrco-core-main').'</span></li>';
                                                $html .= '<li><a href="'.esc_url($profile_url).'">'.get_the_author().'</a></li>';
                                                $html .= '<li><span>'.__(' in ', 'tmrco-core-main').'</span></li>';
                    ...
                    $html .= '<div class="col-md-12">';
                        ...
                        $html .= '<div class="clearfix load-wrap">';
                            ...
                            $html .= '<div class="p-loadmore">';
                                $html .= '<a href="#" class="view-all-course load-more post-loadmore" data-show_layout="'. $layout .'" data-show_column="'.$columns.'" data-per_page="'.$numbers.'" data-total_posts="'.$allposts->publish.'">'.__('View all Courses', 'tmrco-core-main').'</a>';
                            $html .= '</div>';
                        $html .= '</div>';
                    $html .= '</div>';
                }
