...
if (! class_exists('tmrco_Core_Base')) {
    ...
    class tmrco_Core_Base{
		...
		public function post_editor_assets(){
			wp_enqueue_style(
				'tmrco-core-main-editor-editor-css',
			...
			// Scripts.
			wp_enqueue_script(
				'tmrco-core-main-block-script-js',
			...
			wp_localize_script( 'tmrco-core-main-block-script-js', 
			'thm_option', array(
		...
		public function post_block_assets(){
			// Styles.
			wp_enqueue_style(
				'tmrco-core-main-global-style-css',
		...
		public function block_categories( $categories, $post ){
			return array_merge(
				array(
					array(
						'slug' => 'tmrco-core-main',
						'title' => __( 'tmrco Core', 'tmrco-core-main' ),
					)
				),
				$categories
			);
